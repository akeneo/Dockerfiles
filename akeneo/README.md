...
The Dockerfile is available at [Docker hub](https://hub.docker.com/r/carcel/akeneo/). In the `docker-compose.yml` file, you can replace `build: ./` by `image: carcel/akeneo` in the `akeneo:php-5.6` block.
