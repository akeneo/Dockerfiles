...
The Dockerfile is available at [Docker hub](https://hub.docker.com/r/carcel/akeneo/). In the `docker-compose.yml` file, you can replace `build: ./` by `image: carcel/akeneo:php-7.0` in the `akeneo` block.
