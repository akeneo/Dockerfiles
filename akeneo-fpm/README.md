...
The Dockerfile is available at [Docker hub](https://hub.docker.com/r/carcel/akeneo-fpm/). In the `docker-compose.yml` file, you can replace `build: ./` by `image: carcel/akeneo-fpm:php-5.6` in the `akeneo` block.
