...
As *xdebug* is activated by default on development images, it is recommanded to first deactivate it, then run the initialization, and finally enable it again.
