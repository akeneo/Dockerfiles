...
- [`pim-initialize` script](https://github.com/damien-carcel/Dockerfiles/blob/master/akeneo-apache/files/pim-initialize.sh) will completely remove the application cache, logs, assets (`web/bundles/*`, `web/css/*`, `web/js/*`),
