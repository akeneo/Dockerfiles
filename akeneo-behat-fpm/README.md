...
The Dockerfile is available at [Docker hub](https://hub.docker.com/r/carcel/akeneo-behat-fpm/). In the `docker-compose.yml` file, you can replace `build: ./` by `image: carcel/akeneo-behat-fpm` in the `akeneo` block.
